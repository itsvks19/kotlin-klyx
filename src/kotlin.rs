...
use klyx::serde_json;
use klyx_extension_api::{self as klyx, Result, settings::LspSettings};
...
impl klyx::Extension for KotlinExtension {
    fn new() -> Self {
        Self {
    ...
    fn language_server_workspace_configuration(
        &mut self,
        language_server_id: &LanguageServerId,
        worktree: &klyx_extension_api::Worktree,
...
klyx::register_extension!(KotlinExtension);
